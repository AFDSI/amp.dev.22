...
(function (m, q) {
  'object' === typeof exports && 'undefined' !== typeof module
    ...
    : 'function' === typeof define && define.amd
      ? define(['exports'], q)
      : ((m = m || self), q((m.AmpToolboxCacheUrl = {})));
})(this, function (m) {
  function q(a) {
    try {
  ...
  function z(a) {
    ...
    var d = typeof a,
      c;
    if ('blob:' === a.protocol) b = new k(unescape(a.pathname), {});
    else if ('string' === d) for (c in ((b = new k(a, {})), B)) delete b[c];
    else if ('object' === d) {
  ...
  function k(a, b, d) {
    ...
    for (f.slashes || (c[3] = [/(.*)/, 'pathname']); l < c.length; l++)
      if (((f = c[l]), 'function' === typeof f)) a = f(a);
      else {
        var h = f[0];
        var g = f[1];
        if (h !== h) this[g] = a;
          ...
          ~(h = a.indexOf(h)) &&
            ('number' === typeof f[2]
              ? ((this[g] = a.slice(0, h)), (a = a.slice(h + f[2])))
              : ((this[g] = a.slice(h)), (a = a.slice(0, h))));
        else if ((h = h.exec(a))) (this[g] = h[1]), (a = a.slice(0, h.index));
  ...
  function S(a) {
    ...
    return window.crypto.subtle.digest('SHA-256', a).then((a) => {
      var b = [];
      a = new DataView(a);
  ...
  function v(a) {
    ...
    if (G(a)) var b = !1;
      ...
      (b = x.toUnicode(a)),
        (b =
          63 >= a.length && !(T.test(b) && U.test(b)) && -1 != a.indexOf('.'));
    if (b) {
      b = x.toUnicode(a);
      b = b.split('-').join('--');
      b = b.split('.').join('-');
  ...
  function H(a) {
    ...
    return a.then((a) =>
      V('ffffffffff' + a + '000000').substr(8, Math.ceil((4 * a.length) / 5))
    );
  }
  function V(a) {
    let b = [];
    ...
    for (e = 0; e < c; e++)
      a.push('abcdefghijklmnopqrstuvwxyz234567'.charAt(b[5 * e] >> 3)),
        a.push(
        ...
        a.push(
          'abcdefghijklmnopqrstuvwxyz234567'.charAt((b[5 * e + 1] & 63) >> 1)
        ),
        a.push(
          'abcdefghijklmnopqrstuvwxyz234567'.charAt(
            ((b[5 * e + 1] & 1) << 4) | (b[5 * e + 2] >> 4)
          )
        ),
        a.push(
          'abcdefghijklmnopqrstuvwxyz234567'.charAt(
            ((b[5 * e + 2] & 15) << 1) | (b[5 * e + 3] >> 7)
          )
        ),
        a.push(
          'abcdefghijklmnopqrstuvwxyz234567'.charAt((b[5 * e + 3] & 127) >> 2)
        ),
        a.push(
          'abcdefghijklmnopqrstuvwxyz234567'.charAt(
            ((b[5 * e + 3] & 3) << 3) | (b[5 * e + 4] >> 5)
          )
        ),
        a.push('abcdefghijklmnopqrstuvwxyz234567'.charAt(b[5 * e + 4] & 31));
    c = 0;
  ...
  function I(a, b, d = null) {
    let c = new w(b),
      e = W(c.pathname, d);
    e += 'https:' === c.protocol ? '/s/' : '/';
    return v(c.toString()).then((d) => {
      let f = new w(b);
      f.protocol = 'https';
      d = d + '.' + a;
      f.host = d;
  ...
  let aa =
    ...
    X = {isPathNameAnImage: (a) => aa.some((b) => (a.endsWith(b) ? !0 : !1))},
    ba =
    ...
    Y = {isPathNameAFont: (a) => ba.some((b) => (a.endsWith(b) ? !0 : !1))};
  var A =
  ...
  k.prototype = {
    set: function (a, b, d) {
      switch (a) {
        ...
        case 'port':
          this[a] = b;
          D(b, this.protocol)
            ? b && (this.host = this.hostname + ':' + b)
            : ((this.host = this.hostname), (this[a] = ''));
          break;
        case 'hostname':
          this[a] = b;
    ...
    toString: function (a) {
      ...
      this.username &&
        ((b += this.username),
        this.password && (b += ':' + this.password),
        (b += '@'));
      b += this.host + this.pathname;
      (a = 'object' === typeof this.query ? a(this.query) : this.query) &&
        (b += '?' !== a.charAt(0) ? '?' + a : a);
  ...
  let da = /^xn--/,
    ...
    K = function (a, b, d) {
      let c = 0;
      a = d ? n(a / 700) : a >> 1;
      for (a += n(a / b); 455 < a; c += 36) a = n(a / 35);
            ...
            10 > g - 48
              ...
              : 26 > g - 65
                ...
                : 26 > g - 97
                  ? g - 97
                  : 36;
          (36 <= g || g > n((2147483647 - c) / b)) && p('overflow');
          c += g * b;
          const h = e <= l ? 1 : e >= l + 26 ? 26 : e - l;
          if (g < h) break;
          g = 36 - h;
          b > n(2147483647 / g) && p('overflow');
          b *= g;
        }
        g = b.length + 1;
        l = K(c - h, g, 0 == h);
    ...
    M = function (a) {
      ...
      let d = a.length,
        ...
        e = 0,
        l = 72;
      for (var f of a) 128 > f && b.push(y(f));
      let h = (f = b.length);
      for (f && b.push('-'); h < d; ) {
        var g = 2147483647;
        for (const b of a) b >= c && b < g && (g = b);
        const d = h + 1;
        g - c > n((2147483647 - e) / d) && p('overflow');
        e += (g - c) * d;
        c = g;
        for (const m of a)
          if ((m < c && 2147483647 < ++e && p('overflow'), m == c)) {
            var k = e;
            for (g = 36; ; g += 36) {
              const a = g <= l ? 1 : g >= l + 26 ? 26 : g - l;
              if (k < a) break;
              k -= a;
              const c = 36 - a;
              b.push(y(J(a + (k % c), 0)));
    ...
    x = {
      version: '2.1.0',
      ucs2: {decode: F, encode: (a) => String.fromCodePoint(...a)},
      decode: L,
      encode: M,
      toASCII: function (a) {
    ...
    fa = {createCacheUrl: I, createCurlsSubdomain: v};
  m.createCacheUrl = I;
