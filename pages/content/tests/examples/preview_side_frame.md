...
[example preview="side-frame" playground="true" template="amp-mustache"
...
<html ⚡ lang="en">
  ...
  <body>
    ...
    <p>
      Here is a responsive image carousel implemented in AMP. Tap on one of the
      images to enter the lightbox mode.
    </p>
    <amp-carousel
      type="slides"
      width="400"
    ...
    <p>
      AMP provides a rich set of built-in actions for creating interactive
      websites.
    </p>
    ...
    <p>
      AMP offers different ways to render dynamic content on a page. With
      amp-list it's possible to client-side render data pulled in from a JSON
      endpoint.
    </p>
