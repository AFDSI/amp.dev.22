...
2. أنشئ [إصدار GitHub](https://github.com/ampproject/docs/issues/new). _ إعلان اللغة التي تترجم المستند إليها. _ اسم الملف الذي ترغب في ترجمته أو تحديثه. \* قدم تقديرًا تقريبيًا لعدد كلمات الملف الذي تترجمه.
   - الملف بالكامل
   - جزء من الملف
   - بضع مصطلحات _ قدم تقديرًا عامًا لمقدار الوقت المستغرق لإكمال مهمة الترجمة. _ أضف [CrystalOnScript](https://github.com/CrystalOnScript) حتى التمكن من فرز طلب الترجمة وإبلاغك في حالة ما إذا كان هناك شخص يعمل بالفعل على الترجمة نفسها أم لا:
