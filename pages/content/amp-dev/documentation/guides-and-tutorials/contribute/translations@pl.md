...
2. Utwórz [zgłoszenie GitHub](https://github.com/ampproject/docs/issues/new). _ Wskaż język, na który tłumaczysz dokument. _ Wskaż plik, który chcesz przetłumaczyć lub zaktualizować. \* Podaj zgrubne oszacowanie wielkości tłumaczonej przez Ciebie części pliku.
   - Cały plik
   - Część pliku
   - Kilka terminów _ Podaj ogólne oszacowanie czasu potrxzebnego do wykonania zadania tłumaczenia. _ Dodaj [@CrystalOnScript](https://github.com/CrystalOnScript), aby mogła ocenić żądanie lokalizacji i poinformować Cię w przypadku, gdy ktoś już pracuje nad tym samym tłumaczeniem:
   - Tak! Przetłumacz to!
