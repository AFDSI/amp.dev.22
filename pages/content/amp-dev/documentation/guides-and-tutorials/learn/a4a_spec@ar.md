...
تتطلب تصميمات إعلانات AMPHTML خط نمط نموذجيًا مختلفًا وأبسط كثيرًا مما تتطلبه [مستندات AMP العامة](https://github.com/ampproject/amphtml/blob/main/docs/spec/amp-boilerplate.md):
...
لاحظ أن القواعد نفسها المتعلقة بالطفرات في النص النموذجي مطبقة كما في النص[ النموذجي العام لـ AMP](https://github.com/ampproject/amphtml/blob/main/docs/spec/amp-boilerplate.md).
