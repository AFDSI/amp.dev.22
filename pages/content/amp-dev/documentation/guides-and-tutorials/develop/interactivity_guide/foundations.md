...
<button on="tap:helloWorld.hide">Goodbye World</button>
```
...
```html
<input
  on="tap:hiddenInstructions.show;change:hiddenInstructions.hide"
  tabindex="0"
  role="textbox"
  type="text"
/>
<input type="submit" value="Submit" />
<p hidden id="hiddenInstructions">Type your name!</p>
```
...
<button on="tap:helloHeading.hide,goodbyeHeading.show">Goodbye World</button>
```
...
<body>
  ...
  <button
    on="tap:togleHeading.toggleClass(class='red'),togleHeading.toggleClass(class='green', force=false)"
  >
    Toggle Red
  </button>
  <button
    on="tap:togleHeading.toggleClass(class='green'),togleHeading.toggleClass(class='red', force=false)"
  >
    Toggle Green
  </button>
