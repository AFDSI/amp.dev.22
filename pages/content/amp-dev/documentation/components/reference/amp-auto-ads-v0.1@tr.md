...
`amp-auto-ads` ilk reklamını yerleştirdikten sonra sayfada artık 3 reklam vardır. `subsequentMinSpacing` alanında 3 (veya daha fazla) reklam için bir eşleme olduğundan minimum aralık şimdi 500 px olur. 5. reklam için bir kural olduğundan, bu durum sayfada 5 reklam yer alıncaya kadar uygulanır. 6. ve sonraki reklamların eklenmesi için eklenen reklamın, diğer reklamlardan en az 1.000 px uzakta olması gerekir.
