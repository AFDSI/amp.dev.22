commit 13193fd3fdfa7e3e5f5c6e0b5bd36e63f1fdf107
Author: Claude <noreply@anthropic.com>
Date:   Sun Jan 4 19:16:38 2026 +0000

    Add go-links migration context for Claudia
    
    Collected site configuration, go-links data, and build pipeline
    structure to support Netlify redirect migration design.

diff --git a/_claude/GOLINKS-MIGRATION-CONTEXT.md b/_claude/GOLINKS-MIGRATION-CONTEXT.md
new file mode 100644
index 000000000..8878bd718
--- /dev/null
+++ b/_claude/GOLINKS-MIGRATION-CONTEXT.md
@@ -0,0 +1,436 @@
