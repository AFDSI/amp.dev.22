commit dddf504cf2bdc50232e19f88f388dcfe65f073df
Author: Claude <noreply@anthropic.com>
Date:   Fri Jan 2 17:46:08 2026 +0000

    Add boilerplate restoration analysis
    
    Key findings:
    - Complete boilerplate structure exists (build.js, templates, backend)
    - Express route already configured in platform.js (lines 29, 178)
    - Gulp build task exists in gulpfile.js/build.js
    - Only needs: build dist/, update hardcoded URLs
    
    Required changes:
    1. Run `node boilerplate/build.js` to create dist/
    2. Update canonical URL to amp-new.netlify.app
    3. Update service worker iframe URL
    4. Update tools.yaml reference
    
    Risk: LOW - all dependencies and infrastructure in place

diff --git a/_claude/BOILERPLATE-RESTORATION.md b/_claude/BOILERPLATE-RESTORATION.md
new file mode 100644
index 000000000..f1f413e2d
--- /dev/null
+++ b/_claude/BOILERPLATE-RESTORATION.md
@@ -0,0 +1,305 @@
