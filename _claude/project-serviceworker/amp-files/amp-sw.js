!function (e) {
	...
	s.e = function (e) {
		...
		return t.push(Promise.resolve().then(function () {
				n[e] || importScripts('https://cdn.ampproject.org/sw/' + ({
						1: "optional-modules"
					}
						[e] || e) + ".js")
			})),
...
([function (e, t, n) {
			...
			u = function (e, t, n) {
				...
				if (!r(i))
					return;
				if (!n || "groupCollapsed" === e && a)
					return void console[e](...t);
				const o = ["%cworkbox", `background: ${n}; color: white; padding: 2px 0.5em; ` + "border-radius: 0.5em;"];
				console[e](...o, ...t)
			},
			h = () => {
			...
			var s = function (e) {
				...
				for (var n = arguments.length, s = new Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++)
					s[a - 1] = arguments[a];
				return s.length > 0 && (t += ` :: ${JSON.stringify(s)}`),
				t
			};
			n.d(t, "a", function () {
				return a
			...
			const c = async e => {
				...
				for (let e of o)
					s.a.CACHED_RESPONSE_WILL_BE_USED in e && (l = await e[s.a.CACHED_RESPONSE_WILL_BE_USED].call(e, {
								cacheName: t,
								request: n,
								event: a,
								matchOptions: i,
			...
			l = async e => {
				...
				o = !1;
				for (let e of i)
					if (s.a.CACHE_WILL_UPDATE in e && (o = !0, !(r = await e[s.a.CACHE_WILL_UPDATE].call(e, {
										request: t,
										response: r,
										event: a
									}))))
						break;
				return o || (r = r.ok ? r : null),
				r || null
			},
			u = {
				put: async function () {
					...
					try {
						...
						throw "QuotaExceededError" === e.name && await Object(r.a)(),
						e
					}
					for (let e of g)
			...
			const r = {
				fetch: async e => {
					...
					try {
						for (let e of c)
							a.a.REQUEST_WILL_FETCH in e && (t = await e[a.a.REQUEST_WILL_FETCH].call(e, {
										request: t.clone(),
										event: r
									}))
					} catch (e) {
			...
			class r extends i {
				...
				_match(e) {
					...
					return !this._blacklist.some(e => e.test(s)) && !!this._whitelist.some(e => e.test(s))
				}
			}
			class o extends i {
				constructor(e, t, n) {
					super(t => {
						...
						return s ? n.origin !== location.origin && 0 !== s.index ? null : s.slice(1) : null
					}, t, n)
				}
			}
			var c = n(1);
			...
			class l {
				...
				handleRequest(e) {
					...
					if (s = i.handler, a = i.params, n = i.route, !s && this._defaultHandler && (s = this._defaultHandler), !s)
						return void 0;
					let r;
					try {
						r = s.handle({
					...
					return r && this._catchHandler && (r = r.catch(n => this._catchHandler.handle({
									url: t,
									event: e,
									err: n
								}))),
				...
				unregisterRoute(e) {
					...
					if (!(t > -1))
						throw new c.a("unregister-route-route-not-registered");
			...
			class l {
				constructor() {
					let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
					if (this._cacheName = s.a.getRuntimeName(e.cacheName), this._plugins = e.plugins || [], e.plugins) {
						let t = e.plugins.some(e => !!e.cacheWillUpdate);
						this._plugins = t ? e.plugins : [o, ...e.plugins]
					} else
						this._plugins = [o];
			...
			const u = {
				...
				cacheOnly: class {
					...
					async makeRequest(e) {
						let t = e.event,
						n = e.request;
						return "string" == typeof n && (n = new Request(n)),
						await a.a.match({
							cacheName: this._cacheName,
							request: n,
							event: t,
				...
				async open() {
					if (!this._db)
						return this._db = await new Promise((e, t) => {
								...
								s.onupgradeneeded = (e => {
									n ? (s.transaction.abort(), e.target.result.close()) : this._onupgradeneeded && this._onupgradeneeded(e)
								}),
								s.onsuccess = (t => {
									const s = t.target.result;
									n ? s.close() : (s.onversionchange = this._onversionchange, e(s))
								})
							}), this
				}
				async get(e) {
				...
				async transaction(e, t, n) {
					...
					await new Promise((s, a) => {
						...
						for (const t of e)
							r[t] = i.objectStore(t);
						n(r, e => s(e), () => {
							a(new Error("The transaction was manually aborted")),
							i.abort()
						})
					})
				}
				async _call(e, t, n) {
					for (var s = arguments.length, a = new Array(s > 3 ? s - 3 : 0), i = 3; i < s; i++)
						a[i - 3] = arguments[i];
					await this.open();
			...
			class m {
				constructor() {
					...
					e.purgeOnQuotaError && Object(h.b)(() => this.deleteCacheAndMetadata())
				}
				_getCacheExpiration(e) {
					if (e === u.a.getRuntimeName())
						throw new o.a("expire-custom-caches-only");
					let t = this._cacheExpirations.get(e);
					return t || (t = new l(e, this._config), this._cacheExpirations.set(e, t)),
					t
				}
				cachedResponseWillBeUsed(e) {
					...
					return this._getCacheExpiration(t).expireEntries(),
					s ? n : null
				}
			...
			class m extends s.a {
				...
				removeDeniedUrls(e) {
					this._blacklist = this._blacklist.filter(t => t.toString() !== e.toString())
				}
			}
			class f extends a.b {
				constructor(e, t) {
					super(e),
					this._offlineFallbackUrl = t
				}
				async makeRequest(e) {
					let t = e.event,
					n = e.request,
			...
			const g = new class {
				...
				ampAssetsCaching() {
					s.b.registerRoute(r, new a.a({
							cacheName: u,
							plugins: [new i.a({
									maxAgeSeconds: 1209600
								})]
						})),
					s.b.registerRoute(o, new a.c({
							cacheName: l,
							plugins: [new i.a({
									maxAgeSeconds: 604800
								})]
						})),
					s.b.registerRoute(c, new a.c({
							cacheName: l,
							plugins: [new i.a({
									maxAgeSeconds: 86400
								})]
				...
				listenForFetchedScripts() {
					self.addEventListener("message", e => {
						...
						"AMP__FIRST-VISIT-CACHING" === t.type && t.payload && e.waitUntil(async function (e) {
							const t = [],
							n = [];
							e.forEach(e => {
								c.test(e) || o.test(e) ? t.push(new Request(e)) : r.test(e) && n.push(new Request(e))
							});
			...
			w = new class {
				init() {
					...
					var n;
					h() && self.addEventListener("activate", e => {
						e.waitUntil(self.registration.navigationPreload.enable().then(() => {
								n && self.registration.navigationPreload.setHeaderValue(n)
							}))
					});
					const a = {};
					e.allowList ? a.whitelist = e.allowList : e.denyList && (a.blacklist = e.denyList),
					e.timeoutSeconds && e.timeoutSeconds > 5 && (e.timeoutSeconds = 5),
					e.maxDocumentsInCache && e.maxDocumentsInCache > 10 && (e.maxDocumentsInCache = 10);
					const i = new m(new f({
								cacheName: d.a,
								plugins: [new p({
			...
			self.AMP_SW = {
				init: function () {
					...
					g.init(),
					t.offlinePageOptions && (e = t.offlinePageOptions.url);
					const s = w.init(t.documentCachingOptions, e);
					t.assetCachingOptions && n.e(1).then(n.bind(null, 18)).then(async e => {
						const n = new(0, e.AssetCachingAmpModule);
						await n.init(t.assetCachingOptions)
					}),
					t.linkPrefetchOptions && n.e(1).then(n.bind(null, 20)).then(async e => {
						const n = new(0, e.LinkPrefetchAmpModule);
						await n.init(t.linkPrefetchOptions, s)
					}),
					t.offlinePageOptions && n.e(1).then(n.bind(null, 19)).then(async e => {
					...
					self.addEventListener("activate", async e => {
						...
						e.waitUntil(t.claim().then(async() => {
