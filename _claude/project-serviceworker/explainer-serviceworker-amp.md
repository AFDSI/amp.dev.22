...
* **Custom caching strategies**: You can define how different resources should be cached — e.g., *Cache First*, *Network First*, *Stale While Revalidate*, etc.
...
👉 This is how the frontend can ask: *“What was the user’s last search?”*
