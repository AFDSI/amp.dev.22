// generic - no dependencise or links
// see html page
...
(function () {
  ...
  class AssetGroup {
    constructor(scope, adapter, idle, config, hashes, db, prefix) {
      ...
      this.patterns = this.config.patterns.map(
    ...
    handleFetch(req, ctx) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (
          this.config.urls.indexOf(url) !== -1 ||
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (updateFrom !== undefined) {
          ...
          yield (yield updateFrom.previouslyCachedResources())
            ...
            .filter(
              (url) =>
                this.config.urls.some((cacheUrl) => cacheUrl === url) ||
                this.patterns.some((pattern) => pattern.test(url))
            )
              ...
              (previous, url) =>
                __awaiter(this, void 0, void 0, function* () {
                  ...
                  yield metaTable.write(
                    url,
                    Object.assign({}, res.metadata, {used: false})
                  );
                }),
              Promise.resolve()
            );
  ...
  class DataGroup {
    constructor(scope, adapter, config, db, prefix) {
      ...
      this.cache = this.scope.caches.open(
        `${this.prefix}:dynamic:${this.config.name}:cache`
      );
      this.lruTable = this.db.open(
        `${this.prefix}:dynamic:${this.config.name}:lru`
      );
      this.ageTable = this.db.open(
        `${this.prefix}:dynamic:${this.config.name}:age`
      );
    }
    /**
  ...
  class AppVersion {
    constructor(scope, adapter, database, idle, manifest, manifestHash) {
      ...
      const includeUrls = manifest.navigationUrls.filter(
        (spec) => spec.positive
      );
      ...
      return __awaiter$2(this, void 0, void 0, function* () {
        ...
        if (req.url !== this.manifest.index && this.isNavigationRequest(req)) {
          ...
          return this.handleFetch(
            this.adapter.newRequest(this.manifest.index),
            context
          );
        }
        return null;
  ...
  class Driver {
    ...
    handleClick(notification, action) {
      return __awaiter$5(this, void 0, void 0, function* () {
        ...
        NOTIFICATION_OPTION_NAMES.filter(
          (name) => name in notification
    ...
    reportStatus(client, promise, nonce) {
      return __awaiter$5(this, void 0, void 0, function* () {
        ...
        try {
          ...
          client.postMessage(
            Object.assign({}, response, {status: false, error: e.toString()})
          );
        }
      });
    }
      ...
      return __awaiter$5(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (err.isCritical) {
            ...
            yield this.versionFailed(
              appVersion,
              err,
              this.latestHash === appVersion.manifestHash
            );
            event.waitUntil(this.idle.trigger());
            return this.safeFetch(event.request);
          }
          ...
          Object.keys(manifests).map((hash) =>
            __awaiter$5(this, void 0, void 0, function* () {
              try {
                ...
                yield this.scheduleInitialization(
                  this.versions.get(hash),
    ...
    versionFailed(appVersion, err, latest) {
      return __awaiter$5(this, void 0, void 0, function* () {
        ...
        if (this.latestHash === brokenHash || latest) {
          ...
          Array.from(this.clientVersionMap.keys()).forEach((clientId) =>
    ...
    cleanupCaches() {
      return __awaiter$5(this, void 0, void 0, function* () {
        ...
        // that.
        const activeClients = (yield this.scope.clients.matchAll()).map(
          (client) => client.id
        );
        ...
        this.clientVersionMap.forEach((version, _) =>
    ...
    cleanupOldSwCaches() {
      return __awaiter$5(this, void 0, void 0, function* () {
        ...
        yield Promise.all(
          oldSwCacheNames.map((name) => this.scope.caches.delete(name))
        );
      });
    }
    /**
