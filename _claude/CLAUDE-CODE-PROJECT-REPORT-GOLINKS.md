commit 8ddac273944574169698eec5cae1cabe948b3170
Author: Claude <noreply@anthropic.com>
Date:   Sun Jan 4 17:59:06 2026 +0000

    Add go-links Express-to-Netlify migration analysis
    
    Documents dependencies for migrating go-links from Express.js to Netlify:
    - 74 simple redirects + 4 regex patterns (already migrated)
    - Three migration options analyzed (Static TOML recommended)
    - Subdomain routing identified as blocking issue
    - Test coverage verified

diff --git a/_claude/GOLINKS-MIGRATION-ANALYSIS.md b/_claude/GOLINKS-MIGRATION-ANALYSIS.md
new file mode 100644
index 000000000..fc22a3a2c
--- /dev/null
+++ b/_claude/GOLINKS-MIGRATION-ANALYSIS.md
@@ -0,0 +1,320 @@
